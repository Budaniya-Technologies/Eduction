    ...
    <section className="relative w-full overflow-hidden bg-[#f5f5f5] py-10">
      <div className="flex flex-col md:flex-row w-full min-h-[550px]">
        ...
        <div className="relative w-full md:w-1/2 px-6 md:px-16 py-10">
          ...
          <h4 className="text-[#0d47a1] font-bold text-lg sm:text-xl md:text-2xl">
            GURUKUL
          </h4>

          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-black leading-snug mt-2">
            Innovative Online <br /> Teaching Mode
          </h1>

          <p className="text-base sm:text-lg md:text-xl text-[#1565c0] font-medium mt-4">
          ...
          <div className="space-y-6 mt-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-black text-base sm:text-lg md:text-xl">
