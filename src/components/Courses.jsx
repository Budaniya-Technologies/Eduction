    ...
    <section className="bg-gray-100 pt-6 pb-2 px-2 sm:pt-10 sm:px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <h2 className="text-base sm:text-xl font-bold text-black px-4 py-1 sm:px-6 sm:py-2 rounded-full shadow-lg border-2 sm:border-4 border-white inline-block">
            💼 Courses
          </h2>
          <a
            href="#"
