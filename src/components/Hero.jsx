  ...
  return (
    <section className="bg-gray-100 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6  flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        {/* Right: Image */}
        <div className="md:w-1/2 relative z-10 mt-10">
          {/* Purple Circle Behind Image */}
        <div className="absolute top-[-100px] right-[-120px] w-[600px] h-[600px] bg-[#d1a5f0] rounded-full mix-blend-multiply opacity-60 -z-10" />
          <Image
            src={studentImg}
            alt="Students"
            width={400}
