...
//         buttonUrl: '#',
//         image: '/assets/FirstSliderPage.png',
//     },
//     {
//         title: 'Online EducationHub',
//         description: 'Innovative Online Teaching Mode',
...
//         buttonText: 'Explore now',
//         buttonUrl: '#',
//         image: '/assets/SecondSliderPage.png',
//     },
//     {
//         title: 'Online EducationHub',
//         description: 'Innovative Online Teaching Mode',
        ...
        if (Array.isArray(response?.data)) {
          const transformedSlides = response.data.flatMap((item) =>
            item.slides.map((slide) => ({
              title: item.caption || "Online EducationHub",
              description: item.name || "",
              image: `https://api.mypratham.com/media/${slide.image}`,
